...
export class DeviceFingerprintService {
     ...
     */
    static async getMacOSHardwareUUID() {
     ...
     */
    static createDeviceId(hardwareUUID, machineId) {
     ...
     */
    static updateLastSeen(fingerprint) {
        return {
            ...fingerprint,
            lastSeenAt: Date.now(),
        };
     ...
     */
    static getShortDeviceId(deviceId) {
     ...
     */
    static async getCurrentDeviceId() {
        const hardwareUUID = await DeviceFingerprintService.getMacOSHardwareUUID();
        const machineId = os.hostname() + '-' + os.userInfo().username;
     ...
     */
    static detectChanges(current, stored) {
        const changes = [];
     ...
     */
    static sanitizeForLogging(fingerprint) {
        return {
