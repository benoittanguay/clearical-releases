            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-[var(--color-border-primary)] flex-shrink-0">
                        ...
                        <button
                            onClick={onClose}
                            className="p-1 hover:bg-[#FAF5EE] rounded-lg transition-colors text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)]"
                            disabled={isLogging}
                    ...
                    <div className="flex items-center justify-end gap-3 p-4 border-t border-[var(--color-border-primary)] flex-shrink-0 bg-[var(--color-bg-secondary)]">
                        <button
                            onClick={onClose}
                            disabled={isLogging}
                            className="px-4 py-2 text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-[#FAF5EE] rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
