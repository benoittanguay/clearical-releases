...
export const UpdateNotification: React.FC<UpdateNotificationProps> = ({
    ...
    const handleDownloadUpdate = async () => {
        ...
        try {
            ...
            console.error('[UpdateNotification] Failed to open download URL:', error);
        }
    };
    ...
    return (
        <div className="fixed bottom-4 right-4 max-w-sm bg-gray-800 border border-gray-700 rounded-xl shadow-2xl z-50 overflow-hidden">
            {/* Accent bar at top */}
            <div className={`h-1 ${updateStatus.error ? 'bg-red-500' : 'bg-blue-500'}`} />
                ...
                <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center">
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 ${
                            updateStatus.error ? 'bg-red-500/20' : 'bg-blue-500/20'
                        }`}>
                        ...
                        <div>
                            <h3 className="text-sm font-semibold text-white">
                                {updateStatus.available ? 'Update Available' : 'Software Updates'}
                            </h3>
                ...
                {updateStatus.available && (
                    <div className="mb-3">
                        <p className="text-xs text-gray-400 mb-2">
                            A new version is ready to download. Click below to download the DMG file.
                        </p>
