...
ipcMain.handle('meeting:start-file-recording', (_event, micPath: string, systemPath: string) => {
...
ipcMain.handle('meeting:merge-audio-files', async (_event, micPath: string | null, systemPath: string | null, outputPath: string) => {
